<?php
    ...
    require_once ("aplicationObjet.php");
    class managementAplicationObjet extends Conexion{
        ...
        public function getAplication(){
            try {
                ...
                $sql = "SELECT * FROM aplication ORDER BY Fecha DESC ";
                ...
                while ($row = $resultado = $sentencia->fetch(PDO::FETCH_ASSOC)){
                    ...
                    $aplication->setDateAplication($row["Fecha"]);
                ...
                echo "Error: " . $ex->getLine() . $ex->getMessage();
            }
        ...
        public function getAplicationId($id){
            try {
                //code...
                ...
                $count = 0;
                //$this->id = $id;
                $sql = 'SELECT * FROM aplication WHERE Id = :IdList ORDER BY Fecha DESC ';
                $sentencia = $this->conexionDB->prepare($sql);
                $sentencia->bindParam(':IdList', $id);
                $sentencia->execute();
